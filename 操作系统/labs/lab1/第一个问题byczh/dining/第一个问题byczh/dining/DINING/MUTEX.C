...
DWORD WINAPI PhilosopherThread(LPVOID pVoid)
{
	...
	int iPhilosopher = (int) pVoid;             //哲学家编号
	int iLeftChopstick = iPhilosopher;          //左边筷子等于哲学家编号
	int iRightChopstick = iLeftChopstick + 1;   //右边的筷子等于左边的编号+1;
	DWORD result;

	if (iRightChopstick > PHILOSOPHERS-1)       //圆桌
		iRightChopstick = 0;
	...
	myChopsticks[0] = gchopStick[iLeftChopstick];   //哲学家左边的筷子
	myChopsticks[1] = gchopStick[iRightChopstick];  //哲学家右边的筷子
